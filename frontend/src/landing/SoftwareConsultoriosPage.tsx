...
export default function SoftwareConsultoriosPage() {
  ...
  </main><footer className="landing-footer"><div className="landing-container seo-footer"><img src="/brand/mediturnos-logo-horizontal.svg" alt="Turnelia" /><div><a href="/">Inicio</a><a href="/ayuda">Centro de Ayuda</a><a href="/registro">Probar Turnelia</a></div></div></footer></div>;
}
