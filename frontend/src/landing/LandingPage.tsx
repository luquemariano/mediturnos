...
export default function LandingPage() {
  ...
  return <div className="landing-page" onClick={medirRegistro}>
    ...
    <main>
      ...
      <section id="funciones" className="landing-section features"><div className="landing-container"><div className="section-heading"><p className="eyebrow">Funciones</p><h2>Todo lo que necesitás para organizar tu consulta</h2><p>Conocé también nuestro <a href="/software-para-consultorios">software para consultorios</a> y centralizá la gestión diaria.</p></div><div className="features__grid">{funciones.map(([title, text], index) => <article key={title}><LineIcon name={iconos[index]}/><h3>{title}</h3><p>{text}</p></article>)}</div></div></section>
    ...
    <footer className="landing-footer"><div className="landing-container landing-footer__grid"><div><img src="/brand/mediturnos-logo-horizontal.svg" alt="Turnelia"/><p>Agenda y gestión profesional.</p></div><div><h2>Producto</h2><a href="#funciones">Funciones</a><a href="#precios">Precios</a><a href="#demo">Demo</a></div><div><h2>Turnelia</h2><a href="#contacto">Contacto</a><a href="/ayuda">Centro de Ayuda</a><span>Privacidad</span><span>Términos</span></div><div><h2>Acceso</h2><a href="/login">Ingresar</a></div></div><div className="landing-container landing-footer__bottom">© 2026 Turnelia. Todos los derechos reservados.</div></footer>
  </div>;
}
