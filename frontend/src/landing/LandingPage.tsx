  ...
  return <header className="landing-header">
    <div className="landing-container landing-header__inner">
      ...
      <nav id="landing-navigation" className={abierto ? "landing-nav is-open" : "landing-nav"} aria-label="Navegación principal" onClick={() => setAbierto(false)}>
        ...
        <a className="nav-login" href="/login">Ingresar</a><a className="button button--small" href="#demo">Probar Turnelia</a>
      </nav>
    </div>
  </header>;
}
  ...
  return <div className="landing-page">
    ...
    <main>
      <section id="inicio" className="hero"><div className="landing-container hero__grid">
        <div className="hero__copy"><p className="eyebrow">Agenda y gestión profesional</p><h1>La agenda profesional que ordena tu consulta</h1><p className="hero__lead">Turnelia reúne tu agenda, pacientes, disponibilidad y prestaciones en un solo lugar. Organizá tu trabajo diario desde cualquier dispositivo, sin instalaciones ni complicaciones.</p><div className="button-row"><a className="button" href="#demo">Probar Turnelia</a><a className="button button--outline" href="#funciones">Ver cómo funciona</a></div></div>
