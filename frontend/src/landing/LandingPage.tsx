...
const funciones = [
  ...
  ["Gestión de cuenta", "Administrá tu perfil profesional y el acceso a tu cuenta."],
  ["Multidispositivo", "Usá Turnelia desde computadora, tablet o celular."],
];

const iconos = ["calendar", "users", "clock", "briefcase", "account", "devices"];
  ...
  return <div className="landing-page">
    ...
    <main>
      <section id="inicio" className="hero"><div className="landing-container hero__grid">
        <div className="hero__copy"><p className="eyebrow">Agenda y gestión profesional</p><h1>La agenda profesional que ordena tu consulta</h1><p className="hero__lead">Turnelia reúne tu agenda, pacientes, disponibilidad y prestaciones en un solo lugar. Organizá tu trabajo diario desde cualquier dispositivo, sin instalaciones ni complicaciones.</p><div className="button-row"><a className="button" href="/registro">Probar Turnelia</a><a className="button button--outline" href="#funciones">Ver cómo funciona</a></div></div>
