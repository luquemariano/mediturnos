...
const preguntas = [
  ...
  ["¿Los pacientes reciben recordatorios?", "Sí. Turnelia envía recordatorios por email y WhatsApp; el paciente puede confirmar o cancelar el turno desde el mensaje."],
...
export default function ParaPsicopedagogosPage() {
  ...
  return <div className="landing-page psicopedagogos-seo" onClick={medirRegistro}><PsicopedagogosHeader /><main>
    ...
    <section className="landing-section psicopedagogos-seo-reminders"><div className="landing-container psicopedagogos-seo-reminders__grid"><div><p className="eyebrow">Recordatorios por email y WhatsApp</p><h2>Ayudá a mantener actualizada tu agenda</h2><p>Turnelia envía recordatorios automáticos por email y WhatsApp antes del turno. El paciente puede confirmar o cancelar y el estado se actualiza en la agenda.</p></div><div className="psicopedagogos-seo-reminders__card"><strong>Recordatorio de turno</strong><span>Confirmación o cancelación desde el mensaje recibido</span></div></div></section>
