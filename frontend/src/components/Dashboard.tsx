...
function Dashboard(props: DashboardProps) {
  ...
  return <main className="pagina-dashboard"><section className="dashboard">
    <header className="dashboard-encabezado"><div className="marca dashboard-marca"><span className="marca-icono">+</span><div><h1>MediTurnos</h1><p>Gestión médica simple y segura</p></div></div><div className="usuario-resumen"><div className="usuario-avatar">{props.nombre.charAt(0).toUpperCase()}</div><div><strong>{props.nombre}</strong><span>{props.rol}</span></div></div></header>
