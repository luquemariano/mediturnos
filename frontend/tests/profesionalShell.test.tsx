...
it("mantiene Pacientes en la navegación profesional desde cualquier sección", () => {
  ...
  expect(Array.from(navegacion.querySelectorAll("button")).map((button) => button.textContent?.trim())).toEqual(["Inicio", "Mi agenda", "Pacientes", "Mi disponibilidad", "Mis prestaciones", "Reserva online", "Lista de espera", "Mi perfil", "Ayuda"]);
