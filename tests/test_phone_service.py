...
@pytest.mark.parametrize(
    ("value", "expected"),
    [
        ("+54 9 351 123-4567", "543511234567"),
        ("3512277416", "543512277416"),
        ("5493511234567", "543511234567"),
        ("0351 15 1234567", "543511234567"),
...
def test_whatsapp_recipient_requires_active_consent_and_valid_phone():
    ...
    assert get_whatsapp_recipient(patient) == "543511234567"
