...
- **EN CURSO / PENDIENTE DE REVIEWER:** Fase 7B Playwright E2E CI informativo en Pull Requests hacia `main`; conserva `workflow_dispatch`, no es required y no modifica el Ruleset. PR #6, reconciliado contra `main`, ejecutó el run `32600285274` por `pull_request`: cuatro jobs verdes y Playwright `3 passed (4.7s)`. PR #5 quedó registrado como conflicto de merge. Fase 7C (evaluación de required y Ruleset) queda pendiente.
