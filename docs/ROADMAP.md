...
- **EN CURSO:** Fase 7B Playwright E2E CI informativo en Pull Requests hacia `main`; conserva `workflow_dispatch`, no es required y no modifica el Ruleset. Fase 7C (evaluación de required y Ruleset) queda pendiente.
