...
- **IMPLEMENTADA / PENDIENTE DE VALIDACIÓN REMOTA:** Fase 7A Playwright E2E CI; job separado informativo, sólo `workflow_dispatch`, PostgreSQL E2E, Chromium headless, smoke/auth/admin y artifacts limitados a logs sanitizados ante fallo. Fases 7B y 7C quedan pendientes.
