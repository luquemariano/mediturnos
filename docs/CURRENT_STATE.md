...
| Playwright E2E CI | DECLARADO EN CONFIGURACIÓN | Job separado informativo de Fase 7A, sólo `workflow_dispatch`; run remoto `32598856151` verde sobre `a2124ff`, `3 passed`; no required |
